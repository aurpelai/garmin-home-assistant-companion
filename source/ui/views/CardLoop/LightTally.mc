...
// A scope's physical lights counted three ways. Groups are excluded so a group
// and its members are not both counted, and `on` is counted among available
// lights only, an unreachable light having no state worth claiming.
class LightTally {
