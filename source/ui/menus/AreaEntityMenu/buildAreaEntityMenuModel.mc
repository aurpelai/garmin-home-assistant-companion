...
//
// Takes the area id and looks the area up, so absence is discovered and answered
// here rather than at every call site. Returns null when the area is gone.
function buildAreaEntityMenuModel(haState as HaState, areaId as String) as AreaEntityMenuModel or Null {
